 ...
 */
public class ScandtopupFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootview =  inflater.inflate(R.layout.fragment_scandtopup, container, false);
        return rootview;
    }
                                            ...
                                            new Handler().postDelayed(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    if (qrcode.valueAt(0).displayValue.equals("0123456789")) {
                                                        MyDialogUtility.customDialog(getActivity(), true, "TOPUP complete !",
                                                        ...
                                                        MyDialogUtility.customDialog(getActivity(), false, "TOPUP Fail !",
                                                                "Returning to Home Screen", null, new MyDialogUtility.OnDialogClickListener() {
                                                                    @Override
                                                                    public void onDialogClickListener(AlertDialog dialog) {
                                                                        MyDialogUtility.customDialog(getActivity(), false, "TOPUP Fail !",
                                                                                "Plese Contact our Customer Service.", null, new MyDialogUtility.OnDialogClickListener() {
                                                                                    @Override
                                                                                    public void onDialogClickListener(AlertDialog dialog) {
                                                                                        dialog.dismiss();
                                                                                        getActivity().finish();
